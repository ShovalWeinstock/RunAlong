...
const DEFAULT_SHIRT = "6454d76001ba82fa1931ea50";
const DEFAULT_PANTS = "6454d79c01ba82fa1931ea53";
const DEFAULT_SHOES = "6454d82501ba82fa1931ea56";
...
async function addUser(newListing){
    ...
    if (await isValidUser(newListing)) {
        let userObject = {username: newListing.username,
                          ...
                          coins: 0,
                          xp: 0,
                          inventory: [new ObjectId(DEFAULT_PANTS),
                                      new ObjectId(DEFAULT_SHIRT),
                                      new ObjectId(DEFAULT_SHOES) ],
                          bottom: new ObjectId(DEFAULT_PANTS),
                          top: new ObjectId(DEFAULT_SHIRT),
                          shoes: new ObjectId(DEFAULT_SHOES),
                        };
